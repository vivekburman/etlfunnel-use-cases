...
// Renames aadhaar → aadhaar_hash and pan → pan_hash after hashing so downstream connectors
// receive the canonical destination column names.
// Idempotent: a valid hex-SHA256 string (64 hex chars) is left unchanged.
