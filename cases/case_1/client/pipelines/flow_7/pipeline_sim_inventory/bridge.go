...
package client_pipeline_sim_inventory

import (
	client_source_entity "etlfunnel/execution/client/connectors/connector_14/iso_entity_55"
	client_destination_entity "etlfunnel/execution/client/connectors/connector_12/iso_entity_66"
	client_transformer_24 "etlfunnel/execution/client/transformers/transformer_24"
	client_transformer_38 "etlfunnel/execution/client/transformers/transformer_38"
	client_transformer_39 "etlfunnel/execution/client/transformers/transformer_39"
	client_transformer_40 "etlfunnel/execution/client/transformers/transformer_40"
	client_transformer_37 "etlfunnel/execution/client/transformers/transformer_37"
	client_transformer_29 "etlfunnel/execution/client/transformers/transformer_29"
	client_transformer_36 "etlfunnel/execution/client/transformers/transformer_36"
...
func applyTransformations(record map[string]any, pipeline *pipelineContext) (map[string]any, error) {
	...
	result, err = client_transformer_24.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_38.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_39.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_40.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_37.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_29.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_36.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
