...
import (
	client_source_entity "etlfunnel/execution/client/connectors/connector_13/iso_entity_61"
	client_destination_entity "etlfunnel/execution/client/connectors/connector_12/iso_entity_66"
	client_transformer_26 "etlfunnel/execution/client/transformers/transformer_26"
	client_transformer_45 "etlfunnel/execution/client/transformers/transformer_45"
	client_transformer_44 "etlfunnel/execution/client/transformers/transformer_44"
	client_transformer_41 "etlfunnel/execution/client/transformers/transformer_41"
	client_transformer_42 "etlfunnel/execution/client/transformers/transformer_42"
	client_transformer_43 "etlfunnel/execution/client/transformers/transformer_43"
	client_transformer_22 "etlfunnel/execution/client/transformers/transformer_22"
...
func applyTransformations(record map[string]any, pipeline *pipelineContext) (map[string]any, error) {
	...
	result, err = client_transformer_26.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_45.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_44.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_41.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_42.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_43.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_22.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
