...
import (
	client_source_entity "etlfunnel/execution/client/connectors/connector_8/iso_entity_30"
	client_destination_entity "etlfunnel/execution/client/connectors/connector_12/iso_entity_66"
	client_transformer_23 "etlfunnel/execution/client/transformers/transformer_23"
	client_transformer_35 "etlfunnel/execution/client/transformers/transformer_35"
	client_transformer_33 "etlfunnel/execution/client/transformers/transformer_33"
	client_transformer_32 "etlfunnel/execution/client/transformers/transformer_32"
	client_transformer_30 "etlfunnel/execution/client/transformers/transformer_30"
	client_transformer_31 "etlfunnel/execution/client/transformers/transformer_31"
	client_transformer_34 "etlfunnel/execution/client/transformers/transformer_34"
...
func applyTransformations(record map[string]any, pipeline *pipelineContext) (map[string]any, error) {
	...
	result, err = client_transformer_23.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_35.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_33.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_32.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_30.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_31.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
	pipeline.transformerParam.Record = transformedRecord
	result, err = client_transformer_34.Transformer(&pipeline.transformerParam)		
	if err != nil || result == nil {
		return nil, err
	}
	transformedRecord = result
