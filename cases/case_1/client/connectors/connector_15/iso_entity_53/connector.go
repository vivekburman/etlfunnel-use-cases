package client_connector_15_iso_entity_53

// Idea source connector — subscriptions table, zone-only sharding.
// Table name pattern: subscriptions_{zone}_{split}
//
// GeoTagger transformer injects the missing "state" column from pipeline context.
//
//	flow name  "idea_north" → zone = "north"
//	table      subscriptions_north_1
