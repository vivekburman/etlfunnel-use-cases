package client_connector_31_iso_entity_112
...
// Hot Flow Stage 1 — Redis Stream destination for Hyperpure WAL ingestion.
// Publishes raw WAL change events via XADD to hyperpure:orders:stream.
...
// GenerateQuery constructs an XADD command targeting hyperpure:orders:stream.
