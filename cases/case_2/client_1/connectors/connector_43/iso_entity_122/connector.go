package client_connector_43_iso_entity_122
...
// Hot Flow Stage 1 — WAL Ingestion for Hyperpure DB.
// Reads from the hyperpure_slot logical replication slot and publishes raw
// change events to the hyperpure:orders:stream Redis stream.

const (
	Brand           = "hyperpure"
	SlotName        = "hyperpure_slot"
	PublicationName = "hyperpure_pub"
	RedisStream     = "hyperpure:orders:stream"
	FlowType        = "hot_stage1"
)
...
// GenerateWAL returns the replication configuration for the Hyperpure logical
