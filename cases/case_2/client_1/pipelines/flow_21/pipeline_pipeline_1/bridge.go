...
import (
	client_source_entity "etlfunnel/execution/client/connectors/connector_42/iso_entity_123"
	client_destination_entity "etlfunnel/execution/client/connectors/connector_33/iso_entity_110"
