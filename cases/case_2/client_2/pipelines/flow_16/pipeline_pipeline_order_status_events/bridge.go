...
package client_pipeline_pipeline_order_status_events

import (
	client_source_entity "etlfunnel/execution/client/connectors/connector_24/iso_entity_100"
	client_destination_entity "etlfunnel/execution/client/connectors/connector_21/iso_entity_102"
	client_transformer_59 "etlfunnel/execution/client/transformers/transformer_59"
...
func applyTransformations(record map[string]any, pipeline *pipelineContext) (map[string]any, error) {
	...
	result, err = client_transformer_59.Transformer(&pipeline.transformerParam)
