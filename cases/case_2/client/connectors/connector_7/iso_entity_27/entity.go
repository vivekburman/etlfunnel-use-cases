package client_iso_entity_27

// iso_entity_27 — hyperpure / order_status_events / hot flow (STEP-14)
// Belongs to connector_7 (hyperpure Redis stream).

import (
	"context"
	"etlfunnel/execution/core/coreinterface"
	"etlfunnel/execution/models"
	conn "github.com/streamcraft/zomato-etl/db_setup/client/connectors/connector_7"
)
