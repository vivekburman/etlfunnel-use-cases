...
// Belongs to connector_8 (district Redis stream).
// District delivery_assignments carries gate scan events (scanned_at, gate_id);
// schema divergence is handled by transformer_5.

import (
	"context"
	"etlfunnel/execution/core/coreinterface"
	"etlfunnel/execution/models"
	conn "github.com/streamcraft/zomato-etl/db_setup/client/connectors/connector_8"
)
